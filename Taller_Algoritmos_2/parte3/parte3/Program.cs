...
namespace parte3
{
    ...
    { 
        ...
        static void ejercicioCuatro(string letra)
        {
            string clasificacion = "";
            if (letra == "a") clasificacion = "vocal";
            else if (letra == "e") clasificacion = "vocal";
            else if (letra == "i") clasificacion = "vocal";
            else if (letra == "o") clasificacion = "vocal";
            else if (letra == "u") clasificacion = "vocal";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese una opcion: \n" +
                "1. Numeros primos entre el 1 al X \n" +
                "2. Hallar sueldo maximo \n" +
                "3. Numero escrito \n" +
